...
const FALLBACK = [
  ...
  // ══════════════════════════════════════════
  // TREICHVILLE — 24 pharmacies réelles
  // ══════════════════════════════════════════
  {id:245,nom:"Pharmacie Alpha 16",             district:"Treichville",adresse:"Treichville, av. 16, à côté Treichotel",        telephone:"+225 21 25 88 80", est_ouvert:true,  est_garde:false, note:4.4},
  {id:246,nom:"Pharmacie Avenue 21",            district:"Treichville",adresse:"Treichville, av. 21, École Régionale",          telephone:"+225 21 24 83 46", est_ouvert:true,  est_garde:false, note:4.2},
  {id:247,nom:"Pharmacie Belleville",           district:"Treichville",adresse:"Treichville, Belleville, face maquis Notre Dame",telephone:"+225 21 25 09 32", est_ouvert:true,  est_garde:false, note:4.3},
  {id:248,nom:"Pharmacie d'Arras",              district:"Treichville",adresse:"Treichville, Arras, rue 38",                    telephone:"+225 21 24 13 29", est_ouvert:true,  est_garde:false, note:4.1},
  {id:249,nom:"Pharmacie de la Bourse",         district:"Treichville",adresse:"Treichville, avenue 2, rue 20 barrée",          telephone:"+225 21 25 01 28", est_ouvert:true,  est_garde:false, note:4.2},
  {id:250,nom:"Pharmacie de la Caserne",        district:"Treichville",adresse:"Treichville, près Palais des sports, face Marché Portable",telephone:"+225 21 25 45 83",est_ouvert:true,est_garde:false,note:4.3},
  {id:251,nom:"Pharmacie de l'Entente",         district:"Treichville",adresse:"Treichville, av. 21, à côté église Notre Dame", telephone:"+225 21 25 26 95", est_ouvert:true,  est_garde:false, note:4.2},
  {id:252,nom:"Pharmacie des Brasseurs",        district:"Treichville",adresse:"Treichville, carrefour CHU Treichville",        telephone:"+225 21 25 31 51", est_ouvert:true,  est_garde:true,  note:4.6},
  {id:253,nom:"Pharmacie des Quais",            district:"Treichville",adresse:"Treichville, face Grands Moulins d'Abidjan",    telephone:"+225 21 24 04 94", est_ouvert:true,  est_garde:false, note:4.3},
  {id:254,nom:"Pharmacie des Trois Mosquées",   district:"Treichville",adresse:"Treichville, rond-point, av. 8, rue 12",        telephone:"+225 21 24 21 96", est_ouvert:true,  est_garde:false, note:4.2},
  {id:255,nom:"Pharmacie du Cheminot",          district:"Treichville",adresse:"Treichville, quartier France Amérique",         telephone:"+225 21 24 09 45", est_ouvert:true,  est_garde:false, note:4.1},
  {id:256,nom:"Pharmacie du Palais des Sports", district:"Treichville",adresse:"Treichville, Blvd de Marseille, face Hôtel Dieu",telephone:"+225 21 24 02 14",est_ouvert:true,  est_garde:false, note:4.4},
  {id:257,nom:"Pharmacie du Port",              district:"Treichville",adresse:"Treichville, entrée du port de pêche",          telephone:"+225 21 25 21 29", est_ouvert:true,  est_garde:false, note:4.3},
  {id:258,nom:"Pharmacie du Rond Point",        district:"Treichville",adresse:"Treichville, carrefour CHU Treichville",        telephone:"+225 21 35 73 03", est_ouvert:true,  est_garde:false, note:4.2},
  {id:259,nom:"Pharmacie Flora",                district:"Treichville",adresse:"Treichville, av. 8, à côté commissariat 2e arr.",telephone:"+225 21 24 05 91",est_ouvert:true,  est_garde:false, note:4.3},
  {id:260,nom:"Pharmacie France Afrique",       district:"Treichville",adresse:"Treichville, av. 2, face station Mobil",        telephone:"+225 21 24 18 19", est_ouvert:true,  est_garde:false, note:4.2},
  {id:261,nom:"Pharmacie Les Archanges",        district:"Treichville",adresse:"Treichville, derrière Palais des sports",       telephone:"+225 21 35 87 66", est_ouvert:true,  est_garde:false, note:4.1},
  {id:262,nom:"Pharmacie Mégane",               district:"Treichville",adresse:"Treichville, face SOCOCE Treichville",          telephone:"+225 21 25 35 57", est_ouvert:true,  est_garde:false, note:4.3},
  {id:263,nom:"Pharmacie Myriam de Biaffra",    district:"Treichville",adresse:"Treichville, Biaffra",                          telephone:"+225 21 35 76 84", est_ouvert:true,  est_garde:false, note:4.1},
  {id:264,nom:"Pharmacie Nouvelle",             district:"Treichville",adresse:"Treichville, Rue 12, av. 14",                   telephone:"+225 21 35 38 79", est_ouvert:true,  est_garde:false, note:4.2},
  {id:265,nom:"Pharmacie Nouvelle Nanan Yamousso",district:"Treichville",adresse:"Treichville, Rue 38, face immeuble Nanan Yamousso",telephone:"+225 21 24 64 21",est_ouvert:true,est_garde:false,note:4.3},
  {id:266,nom:"Pharmacie Rue 12",               district:"Treichville",adresse:"Treichville, Rue 12, av. 12",                   telephone:"+225 21 24 53 91", est_ouvert:true,  est_garde:false, note:4.2},
  {id:267,nom:"Pharmacie Sainte Adèle",         district:"Treichville",adresse:"Treichville, marché Belleville",                telephone:"+225 21 25 47 00", est_ouvert:true,  est_garde:false, note:4.3},
  {id:268,nom:"Pharmacie Sainte Jeanne",        district:"Treichville",adresse:"Treichville, marché Belleville, avenue 21",     telephone:"+225 21 24 57 41", est_ouvert:true,  est_garde:true,  note:4.5},

  // ══════════════════════════════════════════
  // KOUMASSI — 25 pharmacies réelles
  // ══════════════════════════════════════════
  {id:269,nom:"Pharmacie de la Bagoé",          district:"Koumassi",adresse:"Koumassi, Remblais, bus 11, face Clinique Liring",  telephone:"+225 21 28 64 14", est_ouvert:true,  est_garde:false, note:4.3},
  {id:270,nom:"Pharmacie des Sables",           district:"Koumassi",adresse:"Koumassi, à côté Cité SIR",                        telephone:"+225 21 28 84 17", est_ouvert:true,  est_garde:false, note:4.2},
  {id:271,nom:"Pharmacie du Canal",             district:"Koumassi",adresse:"Koumassi, Remblais Dominique",                     telephone:"+225 21 36 27 48", est_ouvert:true,  est_garde:false, note:4.1},
  {id:272,nom:"Pharmacie du Marais",            district:"Koumassi",adresse:"Koumassi, à côté Cité SIR, quartier Divo",         telephone:"+225 21 36 06 99", est_ouvert:true,  est_garde:false, note:4.2},
  {id:273,nom:"Pharmacie Inch'Allah",           district:"Koumassi",adresse:"Koumassi, à côté Groupe scolaire Entente",         telephone:"+225 21 36 47 01", est_ouvert:true,  est_garde:true,  note:4.5},
  {id:274,nom:"Pharmacie Iroko",                district:"Koumassi",adresse:"Koumassi, Remblais, bus 32",                       telephone:"+225 21 56 43 53", est_ouvert:true,  est_garde:false, note:4.2},
  {id:275,nom:"Pharmacie Kahyra",               district:"Koumassi",adresse:"Koumassi, Blvd du Cameroun, à côté Texaco",        telephone:"+225 21 28 61 94", est_ouvert:true,  est_garde:false, note:4.3},
  {id:276,nom:"Pharmacie Sainte Agathe",        district:"Koumassi",adresse:"Koumassi Remblais, après Le Millénium",            telephone:"+225 21 56 51 88", est_ouvert:true,  est_garde:false, note:4.2},
  {id:277,nom:"Pharmacie Béniabé",              district:"Koumassi",adresse:"Koumassi, terminus bus 13",                        telephone:"+225 21 28 95 25", est_ouvert:true,  est_garde:false, note:4.1},
  {id:278,nom:"Pharmacie Béthanie",             district:"Koumassi",adresse:"Koumassi, Bia Sud, SICOGI, route camp commando",   telephone:"+225 21 36 62 83", est_ouvert:true,  est_garde:false, note:4.2},
  {id:279,nom:"Pharmacie de la Sainte",         district:"Koumassi",adresse:"Koumassi, vers Collège Ajavon, route SICOGI 3e",   telephone:"+225 21 36 22 51", est_ouvert:true,  est_garde:false, note:4.1},
  {id:280,nom:"Pharmacie du Soleil",            district:"Koumassi",adresse:"Koumassi, carrefour Blvd Gabon et marché",         telephone:"+225 21 36 05 98", est_ouvert:true,  est_garde:false, note:4.2},
  {id:281,nom:"Pharmacie Fanny",                district:"Koumassi",adresse:"Koumassi, carrefour bus 32 et 05",                 telephone:"+225 21 36 09 07", est_ouvert:true,  est_garde:false, note:4.4},
  {id:282,nom:"Pharmacie M'Pike",               district:"Koumassi",adresse:"Koumassi, derrière la Mairie de Koumassi",         telephone:"+225 21 36 25 75", est_ouvert:true,  est_garde:false, note:4.2},
  {id:283,nom:"Pharmacie Nouvelle du Boulevard",district:"Koumassi",adresse:"Koumassi, grand carrefour, à côté Chronopost",     telephone:"+225 21 24 37 00", est_ouvert:true,  est_garde:false, note:4.4},
  {id:284,nom:"Pharmacie Saint François",       district:"Koumassi",adresse:"Koumassi, Blvd du Gabon, à côté grand marché",    telephone:"+225 21 36 21 77", est_ouvert:true,  est_garde:false, note:4.3},
  {id:285,nom:"Pharmacie Saint Georges",        district:"Koumassi",adresse:"Koumassi, à côté camp Commando de Koumassi",       telephone:"+225 21 36 03 75", est_ouvert:true,  est_garde:false, note:4.2},
  {id:286,nom:"Pharmacie Saint Louis",          district:"Koumassi",adresse:"Koumassi, Blvd du Cameroun",                       telephone:"+225 21 36 04 15", est_ouvert:true,  est_garde:false, note:4.3},
  {id:287,nom:"Pharmacie Saint Lucien",         district:"Koumassi",adresse:"Koumassi SICOGI, face Ateliers centraux SOTRA",    telephone:"+225 21 28 84 80", est_ouvert:true,  est_garde:false, note:4.2},
  {id:288,nom:"Pharmacie Saint Sauveur",        district:"Koumassi",adresse:"Koumassi, Blvd du Gabon",                         telephone:"+225 21 36 69 93", est_ouvert:true,  est_garde:false, note:4.3},
  {id:289,nom:"Pharmacie du Campement",         district:"Koumassi",adresse:"Koumassi, carrefour du camp",                      telephone:"+225 21 38 18 91", est_ouvert:true,  est_garde:false, note:4.1},
  {id:290,nom:"Pharmacie Prodomo",              district:"Koumassi",adresse:"Koumassi, 2e feu après place Inch'Allah et Pangolins",telephone:"+225 21 28 83 43",est_ouvert:true, est_garde:false, note:4.2},
  {id:291,nom:"Pharmacie Saint Paul",           district:"Koumassi",adresse:"Koumassi, Aklomiabla, vers terminus bus 32",       telephone:"+225 21 36 19 28", est_ouvert:true,  est_garde:false, note:4.1},
  {id:292,nom:"Pharmacie Sainte Foi",           district:"Koumassi",adresse:"Koumassi, Terminus 05, face lycée municipal",      telephone:"+225 21 56 17 40", est_ouvert:true,  est_garde:false, note:4.2},
  {id:293,nom:"Pharmacie Cyrille",              district:"Koumassi",adresse:"Koumassi, Biétry, carrefour Blvd Marseille et Giscard",telephone:"+225 21 25 95 28",est_ouvert:true,est_garde:true, note:4.5},

  // ══════════════════════════════════════════
  // PORT-BOUËT — 15 pharmacies réelles
  // ══════════════════════════════════════════
  {id:294,nom:"Pharmacie Akwaba",               district:"Port-Bouët",adresse:"Port-Bouët, hall Aéroport Félix Houphouët-Boigny",telephone:"+225 21 58 73 15", est_ouvert:true,  est_garde:true,  note:4.7},
  {id:295,nom:"Pharmacie Atlantique",           district:"Port-Bouët",adresse:"Port-Bouët, marché de nuit",                     telephone:"+225 21 27 95 00", est_ouvert:true,  est_garde:false, note:4.3},
  {id:296,nom:"Pharmacie Balnéaire",            district:"Port-Bouët",adresse:"Port-Bouët, face 43e BIMA",                      telephone:"+225 21 58 07 09", est_ouvert:true,  est_garde:false, note:4.2},
  {id:297,nom:"Pharmacie de la Baltique",       district:"Port-Bouët",adresse:"Port-Bouët, face abattoir",                      telephone:"+225 21 27 66 71", est_ouvert:true,  est_garde:false, note:4.1},
  {id:298,nom:"Pharmacie de l'Océan",           district:"Port-Bouët",adresse:"Port-Bouët, Sogephia Siporex",                   telephone:"+225 21 27 78 48", est_ouvert:true,  est_garde:false, note:4.2},
  {id:299,nom:"Pharmacie de Port-Bouët",        district:"Port-Bouët",adresse:"Port-Bouët, à côté Mairie de Port-Bouët",        telephone:"+225 21 27 89 17", est_ouvert:true,  est_garde:false, note:4.4},
  {id:300,nom:"Pharmacie des Entreprises",      district:"Port-Bouët",adresse:"Port-Bouët, Vridi zone industrielle, feu PREMOTO",telephone:"+225 21 27 17 32", est_ouvert:true,  est_garde:false, note:4.2},
  {id:301,nom:"Pharmacie du Phare",             district:"Port-Bouët",adresse:"Port-Bouët, à côté phare de Port-Bouët",         telephone:"+225 21 27 73 73", est_ouvert:true,  est_garde:false, note:4.3},
  {id:302,nom:"Pharmacie du Wharf",             district:"Port-Bouët",adresse:"Port-Bouët, Adjouffou, à côté dépôt SOTRA",      telephone:"+225 21 27 71 31", est_ouvert:true,  est_garde:false, note:4.2},
  {id:303,nom:"Pharmacie Eloma",                district:"Port-Bouët",adresse:"Port-Bouët, Gonzagueville",                      telephone:"+225 21 58 60 28", est_ouvert:true,  est_garde:false, note:4.1},
  {id:304,nom:"Pharmacie Malon",                district:"Port-Bouët",adresse:"Port-Bouët, à côté Grande Mosquée de Port-Bouët",telephone:"+225 21 27 96 14", est_ouvert:true,  est_garde:false, note:4.2},
  {id:305,nom:"Pharmacie Route de Bassam",      district:"Port-Bouët",adresse:"Port-Bouët, Adjouffou, marché avant barrage",    telephone:"+225 21 58 63 54", est_ouvert:true,  est_garde:false, note:4.1},
  {id:306,nom:"Pharmacie Saint Louis de Gonzague",district:"Port-Bouët",adresse:"Port-Bouët, face Lycée municipal",             telephone:"+225 21 58 71 79", est_ouvert:true,  est_garde:false, note:4.3},
  {id:307,nom:"Pharmacie Santé Pour Tous",      district:"Port-Bouët",adresse:"Port-Bouët, route de Bassam, quartier Jean Folly",telephone:"+225 21 58 76 34", est_ouvert:true,  est_garde:false, note:4.2},
  {id:308,nom:"Pharmacie Vridi Village",        district:"Port-Bouët",adresse:"Port-Bouët, carrefour Vridi village, entre SIR et IRAN",telephone:"+225 21 27 58 60",est_ouvert:true,est_garde:true, note:4.4},
...
// NOTE: Ce fichier sera remplacé par la version corrigée ci-dessous
